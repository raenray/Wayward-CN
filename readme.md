...
参考项目：https://github.com/PlotNarrater/wayward-chinese-language.git
...
| 属性 / 技艺 / 品质 / 状态 | 全部覆盖 | — | |
| 动作 (action) | 146/146 | 0 | 全部翻译 |
| 物品 (item) | 839/839 | 0 | 全部翻译 |
| UI 文本 (ui) | 866/925 | 59 | |
| 游戏消息 (message) | 891/891 | 0 | 全部翻译 |
| 键位绑定 (bindable) | 245/245 | 0 | 全部翻译 |
